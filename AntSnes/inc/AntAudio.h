...
public:
	...
	void ConstructL( MAudioListener* aListener);
	static CAntAudio* NewL(TInt aRate, TBool aStereo, TInt aPcmFrames, TInt aVolume, MAudioListener* aListener );
